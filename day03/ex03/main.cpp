...
/*   Updated: 2022/01/24 16:56:12 by ochichep         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
DiamondTrap pure("albert");
std::cout  << "pure is " << pure.getName() << std::endl;
std::cout  << "pure has " << pure.getHitPoints() << " hit points" << std::endl;
std::cout  << std::endl;
